...
Upgrade to a specific release (check [Releases](https://github.com/wwe1428103707/vibe-ipd/releases) for the latest tag):

```bash
uv tool install vibe-ipd --force --from git+https://github.com/wwe1428103707/vibe-ipd.git@vX.Y.Z
```
